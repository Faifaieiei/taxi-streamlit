...
st.markdown("""After selecting the district, start time, and end time, you will get a Nearest Neighbor Distance graph to use 
            as a reference for finding the eps value in the 'Clustering' tab. This tab will display the clustering results obtained.""")
st.markdown("""The principle of selecting the START RANGE and END RANGE is to choose from the range of y-axis values where the graph 
            starts to slope upwards until it becomes a straight line.""")
